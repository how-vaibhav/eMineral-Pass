          ...
          {!showForgotPassword ? (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      >
                        <TextGenerateEffect
                          words="Manage mineral passes & transport records"
                          duration={1}
                          filter={false}
                        />
                      </p>
                    ...
                    >
                      ...
                      >
                        <TextGenerateEffect
                          words="Submit transport forms & get passes"
                          duration={1}
                          filter={false}
                        />
                      </p>
            ...
            >
              ...
              >
                ...
                <p className={isDark ? "text-slate-400" : "text-slate-600"}>
                  <TextGenerateEffect
                    words="Enter your email to receive a password reset link"
                    duration={1}
                    filter={false}
                  />
                </p>
