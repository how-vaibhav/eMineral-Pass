  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white' : 'bg-gradient-to-br from-white via-slate-50 to-white text-slate-900'}`}>
      ...
      <div className="relative min-h-screen flex items-center justify-center px-6 py-12">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className={`w-full max-w-md ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} border rounded-2xl shadow-xl p-8`}>
          {/* Back button */}
          ...
          <div className="mb-8">
            ...
            <p className={isDark ? 'text-slate-400' : 'text-slate-600'}>Join eMineral Pass today</p>
          </div>
          ...
          {/* Sign Up Form */}
          {role && (
            <motion.form onSubmit={handleSubmit} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
              {/* Role badge */}
              ...
              {role === 'host' && (
                <>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Mining License No.</label>
                    <input
                      type="text"
